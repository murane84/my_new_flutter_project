...
part 'home/home_friend_list.dart'; // friend/chat list, Our Space hero, chips, tiles
part 'home/home_space_actions.dart'; // Our Space + friend action flows (open/pin/unpin/moment + sheets)
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 5),
                        Text(
                          // Narrow layouts (phones, or a shrunk web window)
                          // show just the first name so a full "First Last"
                          // doesn't eat the footer's space; wide screens
                          // (desktop) have room for the full name.
                          MediaQuery.of(context).size.width < 640
